...
CREATE TABLE `recommand` (
  ...
  PRIMARY KEY (`number`),
  KEY `fk_articlenumber_idx` (`articlenumber`),
  CONSTRAINT `fk_articlenumber` FOREIGN KEY (`articlenumber`) REFERENCES `article` (`number`) ON DELETE CASCADE ON UPDATE CASCADE
